...
CONFIG_ARCH_MSM7230=y
CONFIG_KERNEL_DEBUGGER_CORE=y
CONFIG_RTC_INTF_PROC=y
CONFIG_STACKTRACE_SUPPORT=y
CONFIG_SPI_QSD_NEW=y
...
CONFIG_ANDROID=y
CONFIG_OPTICALJOYSTICK_CRUCIAL_SPI=y
CONFIG_RPC_SIZE_1024=y
...
CONFIG_SYS_SYNC_BLOCKING_DEBUG=y
...
CONFIG_MSM_RMT_STORAGE_SERVER=y
...
CONFIG_VMALLOC_RESERVE=0x24000000
CONFIG_CP_ACCESS=m
CONFIG_RTC_LIB=y
...
CONFIG_DOCK_ACCESSORY_DETECT=y
...
CONFIG_HID=y
CONFIG_GPU_MSM_KGSL_ADRENO205=y
...
CONFIG_PROC_COMM_TIMEOUT_RESET=y
...
CONFIG_IFB=y
CONFIG_HAS_IOPORT=y
CONFIG_MSM_CPU_FREQ_MAX=1017600
...
CONFIG_ARCH_MSM=y
CONFIG_CIFS=y
CONFIG_TOUCHSCREEN_ELAN_KTF2K=y
